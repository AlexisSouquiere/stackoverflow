...
<head>
    ...
    <title><g:message code="question.page.edit.title"/> - <g:message code="stackoverflow.title"/></title>
</head>
...
<section class="content question-create">
    <div class="row">
        ...
        <section class="col-md-10 col-md-offset-1">
            <g:form controller="question" method="PUT" id="${question?.id}" class="form-horizontal">
            <%-- Title --%>
            ...
            <%-- Tags bar --%>
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                        <g:select name="tags" id="tags" from="${allTags}" value="${selectedTags}" optionKey="id" optionValue="label" multiple="true" class="form-control select2" />
                    </div>
                </div>
            <%-- /Tags bar --%>
                ...
                <div class="row">
                    <div class="col-sm-1">
                        <g:actionSubmit action="update" value="${message(code: 'question.edit.save.label')}"
